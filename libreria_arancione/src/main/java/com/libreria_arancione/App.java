...
public class App {
    public static void main(String[] args) {
        ...
        LibreriaArancione.addBook("zero and ones", "sadie plath", 21, 5545, "independent");
        LibreriaArancione.addBook("glitch feminism", "Legacy Russel", 23, 43423, "independent");
        LibreriaArancione.addBook("an appartament in uranus", "paul preciado", 31, 23125,
                "penguin");
