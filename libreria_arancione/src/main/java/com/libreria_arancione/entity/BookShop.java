...
@Table(name = "library")
public class BookShop extends BaseEntity implements Serializable {
    ...
    public BookShop(String title, String author, int yearOfPublication, int ISBN, CoverType coverType,
            String publisher) {
        this.title = title;
        this.author = author;
